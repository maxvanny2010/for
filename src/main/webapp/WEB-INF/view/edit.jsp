    ...
    <div class="d-flex justify-content-between"
        ...
        <div>
            <div style="display: inline-block; margin-right: 25px">кабинет:
                <a href="<spring:url value="/cabinet?name=${name}"/>"><b>${name}</b></a>
            </div>
        ...
        <div class="container" style="width: 1000px">
            <div class="float-left" style="width: 250px;">
                <form name="${action eq 'create'? 'create': 'update'}"
                    ...
                    <div class="form-group">
                        <label class="sr-only" for="desc">Desc</label>
                        <textarea style="width: 250px; height: 100px" id="desc" required maxlength="2000"
                                  name="desc">${action eq 'update' ? post.desc : ''}</textarea>
                    </div>
                    <div class="form-group">
                        <input class="btn"
